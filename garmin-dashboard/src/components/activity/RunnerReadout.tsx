...
interface RunnerReadoutProps {
  xMode: XMode;
  // Real MetricKey now (HRA-316 folded "stamina" into the union) — this
  // component renders whatever ChartRow fields its caller populated, same as
  // before.
  metrics: MetricKey[];
  speedMode: SpeedMode;
    ...
    content = (
      <>
        ...
        {metrics.map(key => {
          ...
          const color = METRIC_DEFS[key].color;
          return (
